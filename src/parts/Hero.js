    ...
    <div className="flex justify-between items-center">
      <div className="w-1/2">
        <h1 className="text-5xl font-semibold text-white mb-5">
          <span className="text-teal-400">The New</span> Way to <br /> Achive
        ...
        <form onSubmit={submit}>
          ...
          />
          <button className="bg-orange-500 hover:bg-orang-400 transition-all duration-200 focus:outline-none shadow-inner text-white px-6 py-3">
            Daftar Now
          </button>
        </form>
      </div>
